 ...
 */
//자동 완성 기능을 구현한다고 가정한다. 첫 번째 구현에는 간단한 문자열 Array를 사용하고, 두 번째 구현에는 Trie를 사용한다.
//데이터베이스에 총 100,000 개의 항목이 있고, "pri" 접두사(prefix)를 가진 4개의 항목
//"prior", "print", "priority", "prius"이 포함되어 있을 경우, trie가 array에 비해 얼마다 더 빠른지 확인한다.
