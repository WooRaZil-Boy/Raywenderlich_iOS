...
//이 문제를 해결하기 위해 allVertices 속성이 Graph 프로토콜에 추가되었다. 이 속성은 AdjacencyMatrix, AdjacencyList에 이미 구현되어 있다.
...
//visited Set에 정점이 누락되어 있는 경우, 그래프는 연결이 끊어진 것으로 간주된다.
