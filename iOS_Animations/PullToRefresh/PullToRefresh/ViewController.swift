...
class ViewController: UITableViewController, RefreshViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let refreshRect = CGRect(x: 0.0, y: -kRefreshViewHeight, width: view.frame.size.width, height: kRefreshViewHeight) //주어진 높이 만큼 위에 숨겨져 있도록
    ...
    func refreshViewDidRefresh(_ refreshView: RefreshView) { //델리게이트 메서드
        delay(seconds: 4) {
